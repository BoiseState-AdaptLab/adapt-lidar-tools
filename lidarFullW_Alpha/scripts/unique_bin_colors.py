...
def createImage(tif, path):
  ...
  colors = [[128,0,128],[0,0,255],[0,255,0],[255,255,0],[255,128,0],[255,0,0]]
  ...
  bin_colors[0][0] = [128,0,128]
  bin_colors[num_sections - 1][1] = [255,0,0]
  for i in range(num_sections):
    if i != 0:
      temp = tif.getHeatMapColor(colors, i/num_sections)
      bin_colors[i][0] = temp
      bin_colors[i-1][1] = temp

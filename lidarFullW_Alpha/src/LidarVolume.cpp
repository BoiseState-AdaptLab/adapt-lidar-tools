...
int LidarVolume::writeImage(char* filename, int width, int height, 
...
float* LidarVolume::createImage(int width, int height, float xS, float yS, 
                                float rad, int maxIteration)
{
